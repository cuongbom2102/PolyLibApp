...
const Book = () => {
    ...
    const [isClickPicker, setIsClickPicker] = useState(false)
        ...
        if (Platform.OS === 'ios') {
            ...
            return <View style={{
                ...
                >
                    <View style={{
                        ...
                        >
                            <Text style={{ alignSelf: 'center' }}>
                                {selectedValue === '' ? 'Hãy chọn loại sách' : selectedValue}
                            </Text>
                        </TouchableOpacity>
                        <Ionicons name="chevron-down" size={25} color="black" style={{
                    ...
                    >
                        <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center', backgroundColor: 'rgba(0, 0, 0, 0.5)', borderRadius:10 }}>
                            <View style={{
                                width: wp('92.7%'),
                                height: hp('7%'),
                                justifyContent:'center',
                            ...
                            <View style={{
                                ...
                                >
                                    {typeBook.map((item, index) => (
                                        <Picker.Item key={index} label={item.typeBook} value={item.typeBook} />
                                    ))}
                                </Picker>
                            </View>
                        </View>
    ...
    const renderContentUpdate = (status) => {
        if (Platform.OS === 'ios') {
            // Điều kiện cho iOS
            return <View style={{
                width: wp('100%'),
                ...
                >
                    <View style={{
                        ...
                        >
                            <Text style={{ alignSelf: 'center' }}>
                                {selectedValue === itemSelect.typeBook || selectedValue === '' ? itemSelect.typeBook : selectedValue}
            ...
            return <View>
                <Picker
                    selectedValue={isClickPicker === false ? itemSelect.typeBook : selectedValue}
                    onValueChange={(itemValue, itemIndex) => {
                        setSelectedValue(itemValue)
                        setIsClickPicker(true)
                    }
                    }
                >
                    {typeBook.map((item, index) => (
    ...
    const renderItem = ({ item }) => (
        <View style={styles.item}>
            ...
            <View style={{
                ...
                <Text style={styles.textName}>{item.author}</Text>
            ...
            >
                ...
                {dialogVisible && (
                    ...
                    >
                        ...
                        <View style={styles.dialogHeader}>
                            <Text style={styles.dialogTitle}>Add Book</Text>
                ...
                {dialogUpdateVisible && (
                    ...
                    >
                        {/* Nội dung của dialog */}
                        <View style={styles.dialogHeader}>
                            <Text style={styles.dialogTitle}>Update Book</Text>
                            <TouchableOpacity style={styles.closeButton} onPress={closeDialogUpdate}>
                                <Ionicons name="close" size={25} color="white" />
                            </TouchableOpacity>
                        </View>
                        {renderContentUpdate(itemSelect)}
